...
function fnFormatDetails(oTable, nTr) {
    ...
    sOut += '<tr><td>Rendering engine:</td><td> <a title="Detay" href="/Admin/Category/CategoryDetail/' + aData[1] + '">' + aData[2] + ' </a>(Detay sayfası yok dikkat!!)   </td></tr>';
    sOut += '<tr><td>Link to source:</td><td><a title="İçerik" href="/Admin/Product/ProductList/' + aData[1] + '">' + aData[2] + ' </a></td></tr>';
